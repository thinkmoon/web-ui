import { u as du, l as ra, b as Cf, A as gh, c as U6 } from '../server.mjs';
...
const l = defineComponent({ __name: "[pageIndex]", __ssrInlineRender: true, async setup(_) {
  let i, p;
  const f = du(), n = useRoute(), a = n.params.pageIndex, { data: m } = ([i, p] = withAsyncContext(() => R("res", () => gh.getList({ current: a }), "$66Eht5WzLu")), i = await i, p(), i), v = reactive(m.value.records);
  return v.forEach((s) => {
    ...
    const T = resolveComponent("Title"), $ = U6, g = ra.ElLink;
...
const Be = Cf(l, [["__scopeId", "data-v-631eddd1"]]);

export { Be as default };
//# sourceMappingURL=_pageIndex_.28927238.mjs.map
