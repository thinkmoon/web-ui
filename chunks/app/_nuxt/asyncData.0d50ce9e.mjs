...
function useAsyncData(...args) {
  ...
  if (!nuxt._asyncData[key]) {
    nuxt._asyncData[key] = {
      data: vue_cjs_prod.ref(useInitialCache() ? nuxt.payload.data[key] : (_g = (_f = options.default) == null ? void 0 : _f.call(options)) != null ? _g : null),
      pending: vue_cjs_prod.ref(!useInitialCache()),
      error: vue_cjs_prod.ref((_h = nuxt.payload._errors[key]) != null ? _h : null)
    };
  }
  ...
  asyncData.refresh = (opts = {}) => {
    ...
    nuxt._asyncDataPromises[key] = new Promise(
      ...
      asyncData.data.value = vue_cjs_prod.unref((_b2 = (_a2 = options.default) == null ? void 0 : _a2.call(options)) != null ? _b2 : null);
    }).finally(() => {
...
//# sourceMappingURL=asyncData.0d50ce9e.mjs.map
