...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.40c07f4a.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.0f48d288.mjs'));
...
//# sourceMappingURL=error-component.587e3407.mjs.map
