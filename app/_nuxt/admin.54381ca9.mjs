import { l as Ra, b as mv, _ as Q3 } from '../server.mjs';
...
const w = defineComponent({ __name: "admin", __ssrInlineRender: true, setup(H) {
  ...
  return (O, k, D, G) => {
    const z = Ra.ElContainer, I = Ra.ElHeader, C = Q3, p = Ra.ElMenu, l = Ra.ElMenuItem, m = Ra.ElSubMenu, N = Ra.ElScrollbar, h = Ra.ElMain, E = Ra.ElBreadcrumb, o = Ra.ElBreadcrumbItem, A = resolveComponent("NuxtChild");
...
const We = mv(w, [["__scopeId", "data-v-31cf687d"]]);

export { We as default };
//# sourceMappingURL=admin.54381ca9.mjs.map
