import { u as du, l as ra, b as Cf, e as W6 } from '../server.mjs';
...
const d = defineComponent({ __name: "index", __ssrInlineRender: true, setup(a) {
  const e = du();
  return (n, t, p, y) => {
    const B = resolveComponent("Title"), C = ra.ElLink, l = ra.ElButton, b = W6;
...
const gt = Cf(d, [["__scopeId", "data-v-ed12b214"]]);

export { gt as default };
//# sourceMappingURL=index.54f6f108.mjs.map
