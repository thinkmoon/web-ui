...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.dc86da8a.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.f2095122.mjs'));
...
//# sourceMappingURL=error-component.b19c8af5.mjs.map
