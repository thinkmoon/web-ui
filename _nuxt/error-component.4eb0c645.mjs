...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.f683a101.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.95058d9c.mjs'));
...
//# sourceMappingURL=error-component.4eb0c645.mjs.map
