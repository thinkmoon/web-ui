import { u as Ec, T as rO, A as cy, c as eG } from '../server.mjs';
...
const T = defineComponent({ __name: "[pageIndex]", __ssrInlineRender: true, async setup(s) {
  let o, e;
  const n = Ec(), p = useRoute();
  Number(p.params.pageIndex);
  const [{ data: a }, { data: x }] = ([o, e] = withAsyncContext(() => Promise.all([R("tag", () => rO.getTag({ name: p.params.name }), "$GbK67nOY82"), R("post", () => cy.getListByTag({ name: p.params.name }), "$vQsqaCTJpb")])), o = await o, e(), o), u = reactive(x.value);
  return u.forEach((i) => {
...
export { T as default };
//# sourceMappingURL=_pageIndex_.f5d25629.mjs.map
