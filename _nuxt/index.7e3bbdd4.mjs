import { u as Ec, l as Ra, b as mv, T as rO } from '../server.mjs';
...
const c = defineComponent({ __name: "index", __ssrInlineRender: true, async setup(l) {
  let e, o;
  const u = Ec(), { data: C } = ([e, o] = withAsyncContext(() => R("tag", () => rO.getTag(), "$qM7mDDnpFG")), e = await e, o(), e);
  return (G, r, f, I) => {
...
const St = mv(c, [["__scopeId", "data-v-9617272d"]]);

export { St as default };
//# sourceMappingURL=index.7e3bbdd4.mjs.map
