import { u as du, C as PT, A as gh, c as U6 } from '../server.mjs';
...
const x = defineComponent({ __name: "[pageIndex]", __ssrInlineRender: true, async setup(s) {
  let o, r;
  const n = du(), p = useRoute(), a = { total: 0, current: 0 };
  a.current = Number(p.params.pageIndex);
  const [{ data: u }, { data: y }] = ([o, r] = withAsyncContext(() => Promise.all([R("category", () => PT.getCategory({ name: p.params.name }), "$EkkhNl6e4o"), R("post", () => gh.getList({ ...a, category: p.params.name }), "$sWFld4Glrr")])), o = await o, r(), o), c = reactive(y.value.records);
  return c.forEach((i) => {
...
export { x as default };
//# sourceMappingURL=_pageIndex_.2e2223af.mjs.map
