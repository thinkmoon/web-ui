...
import { A as gh, l as ra, f as ST } from '../server.mjs';
...
const N = defineComponent({ __name: "post-list", __ssrInlineRender: true, setup(A) {
  ...
  D();
  function D() {
    gh.getList({ current: a.index, size: a.size }).then((s) => {
...
export { N as default };
//# sourceMappingURL=post-list.4ee0e803.mjs.map
