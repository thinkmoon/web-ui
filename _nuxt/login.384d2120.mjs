import { u as du, h as TN, l as ra, b as Cf, g as Fo } from '../server.mjs';
...
class J {
  static login(m) {
    return Fo({ method: "post", url: "/user/login", data: m });
  }
}
const y = defineComponent({ __name: "login", __ssrInlineRender: true, setup(v) {
  const m = du(), _ = TN("auth", { domain: "thinkmoon.cn", maxAge: 3600 }), o = reactive({ account: "", password: "" });
  function C() {
    J.login(o).then((F) => {
      _.value = F;
    }).catch(() => {
...
const $o = Cf(y, [["__scopeId", "data-v-cda3f1fb"]]);

export { $o as default };
//# sourceMappingURL=login.384d2120.mjs.map
