import { u as Ec, b as mv, A as cy } from '../server.mjs';
...
const a = defineComponent({ __name: "[cid]", __ssrInlineRender: true, async setup(u$1) {
  let e, r;
  const m = Ec(), s = useRoute(), { data: t } = ([e, r] = withAsyncContext(() => R("article", () => cy.getDetail({ cid: s.params.cid }), "$o1yr1BdR3r")), e = await e, r(), e), C = `https://www.thinkmoon.cn/post/${s.params.cid}`;
...
const Bt = mv(a, [["__scopeId", "data-v-2f3d531b"]]);

export { Bt as default };
//# sourceMappingURL=_cid_.9c0c48aa.mjs.map
