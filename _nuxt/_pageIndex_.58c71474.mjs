import { u as useRuntimeConfig, T as TagApi, A as ArticleApi, c as __nuxt_component_0$1 } from '../server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const [{ data: tag }, { data: post }] = ([__temp, __restore] = withAsyncContext(() => Promise.all([
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Title, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`\u6807\u7B7E&quot; ${ssrInterpolate(unref(tag)[0].name)}&quot;\u4E0B\u7684\u6587\u7AE0 | ${ssrInterpolate(unref(config).TITLE)}`);
          } else {
            return [
              createTextVNode('\u6807\u7B7E" ' + toDisplayString(unref(tag)[0].name) + '"\u4E0B\u7684\u6587\u7AE0 | ' + toDisplayString(unref(config).TITLE), 1)
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=_pageIndex_.58c71474.mjs.map
