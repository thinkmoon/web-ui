import { u as du, l as ra, b as Cf, C as PT } from '../server.mjs';
...
const d = defineComponent({ __name: "index", __ssrInlineRender: true, async setup(u) {
  let e, o;
  const l = du(), { data: b } = ([e, o] = withAsyncContext(() => R("category", () => PT.getCategory(), "$6No3WsCJtH")), e = await e, o(), e);
  return (P, r, f, T) => {
...
const St = Cf(d, [["__scopeId", "data-v-38bcea0b"]]);

export { St as default };
//# sourceMappingURL=index.c8b9718e.mjs.map
